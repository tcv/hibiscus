...
#    lim_Cal_time = array(lim_Cal_time)
    lim_Temp_gain=loadtxt(cal_dir+date_name+'TempGain_avg_take2.txt')
    lim_GainR = loadtxt(cal_dir+date_name+'Real_Gain_avg_take2.txt')
    lim_GainX=loadtxt(cal_dir+date_name+'Imag_Gain_avg_take2.txt')
    lim_InR=loadtxt(cal_dir+date_name+'Real_In_avg_take2.txt')
    lim_InX=loadtxt(cal_dir+date_name+'Imag_In_avg_take2.txt')
    lim_VnR=loadtxt(cal_dir+date_name+'Real_Vn_avg_take2.txt')
    lim_VnX=loadtxt(cal_dir+date_name+'Imag_Vn_avg_take2.txt')
...
#pylab.ylim(0,2e18)
pylab.savefig(cal_dir+'overall_cal_temp_take2',dpi=300)
pylab.clf()
...
pylab.ylim(0,5e11)
#pylab.ylim(0,2e18)
pylab.savefig(cal_dir+'overall_cal_temp_mean_take2',dpi=300)
pylab.clf()

savetxt(cal_dir+'Real_In_avg_take2.txt',mean_IR,delimiter = ' ')
savetxt(cal_dir+'Imag_In_avg_take2.txt',mean_IX,delimiter = ' ')
savetxt(cal_dir+'Real_Vn_avg_take2.txt',mean_VR,delimiter = ' ')
savetxt(cal_dir+'Imag_Vn_avg_take2.txt',mean_VX,delimiter = ' ')
savetxt(cal_dir+'Real_Gain_avg_take2.txt',mean_GR,delimiter =' ')
savetxt(cal_dir+'Imag_Gain_avg_take2.txt',mean_GX,delimiter =' ')
savetxt(cal_dir+'TempGain_avg_take2.txt',mean_TG,delimiter=' ')
savetxt(cal_dir+'Cal_time_take2.txt',diff_time,delimiter=' ')
savetxt(cal_dir+'Cal_freq_take2.txt',new_freq,delimiter=' ')
